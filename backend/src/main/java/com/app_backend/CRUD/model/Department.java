...
public class Department {
    ...
    public String toString() {
        return String.format(
                "Department{id:%d, departmentName:'%s', departmentCode:'%s', headOfDepartment:'%s', facultyCount:%d, studentCount:%d, buildingName:'%s', floorNumber:%d, phone:'%s', email:'%s', departmentType:'%s'}",
